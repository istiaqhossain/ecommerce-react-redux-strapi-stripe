...
export default function ProductCategory() {
  ...
  async function fetchCategoryData() {
    try {
      const response = await fetchData( `categories?fields[0]=name&filters[slug][$eq]=${catSlug}&sort=id:desc` );
  ...
  async function fetchProductsData() {
    try {
      const response = await fetchData( `products?populate=*&filters[categories][slug][$eq]=${catSlug}&sort=id:desc` );
      ...
      <div>
              ...
              <form className="mt-4 border-t border-gray-200">
                ...
                <div className="border-t border-gray-200 px-4 py-6">
                  ...
                  <div className="pt-6" id="filter-section-mobile-2">
                    <div className="space-y-6">
                      <div className="flex items-center">
                        <input id="filter-mobile-size-0" name="size[]" value="2l" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-gray-600 focus:ring-gray-500" />
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">{category?.attributes?.name}</h1>
              ...
              <form className="hidden lg:block">
                ...
                <div className="border-b border-gray-200 py-6">
                  ...
                  <div className="pt-6" id="filter-section-2">
                    <div className="space-y-4">
                      <div className="flex items-center">
                        <input id="filter-size-0" name="size[]" value="2l" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-gray-600 focus:ring-gray-500" />
